...
var sum = function(array) {
  if (array.length === 0){
    ...
    var popVar = arrayCopy.pop();
    arrayCopy[arrayCopy.length - 1] = arrayCopy[arrayCopy.length - 1] + popVar;
...
if (Array.isArray(array[0]) === false && array.length === 1){
    ...
    var popVar = flatCopy.pop();
    flatCopy[flatCopy.length -1] = flatCopy[flatCopy.length - 1] + popVar;
    return arraySum(flatCopy);
